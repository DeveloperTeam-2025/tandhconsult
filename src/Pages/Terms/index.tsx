      ...
      <section className={styles.condition} id="condition">
        <div className={styles.container}>
          ...
          <article className={classNames(`${styles.condition_short} wow animate__animated animate__fadeInUp`)} >
            ...
            <div className={styles.condition_block}>
              <h3 className={styles.wp_block_heading}>
                <strong>The following are the Terms and Conditions of T&H Consulting.</strong>
              </h3>
              <p>T&H Consulting (www.tandhconsult.com) is the brand name of T&H Consulting International KFT, registration number 01-09-350838 VAT HU27125508.</p>
            </div>
          </article>
          ...
          <article className={classNames(`${styles.condition_block} wow animate__animated animate__fadeInUp`)} >
            ...
            <ol>
              <li>Full Refund for Erroneous Payment:
                <ul>
                  ...
                  <li>To be eligible for a refund, you must not have had any contact with T&H Consulting, and a refund request must be sent within 24 hours of the transaction.</li>
                </ul>
              </li>
              ...
              <li>If a client cancels a service, T&H Consulting can claim payment for work done and research hours for the remainder of the service. If T&H Consulting set aside time for the service, the client may be charged 50% of the fee for the unperformed part of the work.</li>
              <li>If you decide to cancel a service provided by T&H Consulting after work has been completed, no refund can be issued, regardless of the outcome or results obtained.</li>
            </ol>
            <p>Please note that once work has been performed and the necessary documentation and agreement have been provided, T&H Consulting has fulfilled its obligations, and refunds are no longer applicable.</p>

            <h4>Pricing & Payment</h4>
            <p>Prices are applicable to services that meet agreed specifications. Extra costs or work, due to reasons like unclear specifications or faulty files, may cause a price increase. Full payment is due prior to work commencement or as agreed by T&H Consulting.</p>

            <h4>T&H Consulting Cancellations</h4>
            <p>The agreement remains valid until services are completed or if the relationship terminates under certain conditions, like the client not providing required documentation within 30 days or T&H Consulting unable to contact the client for 15 days. Misleading information, failure to pay, and withholding information may also lead to contract termination without refund.</p>
            <p>We recommend clients to reach out to us if they experience any issues with our services.</p>

            <h3>Limitation of Liability</h3>
            <p>In no event shall T&H Consulting, its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential, or punitive damages resulting from the services provided. The Company’s liability is limited to the maximum extent permitted by law, except in cases of gross negligence, willful misconduct, or fraud by the Company.</p>

            <h3>Professional Consultation and Website Use</h3>
            <p>The information available on our website is not intended to replace consultation with professional advisors. It is provided for general informational purposes only. T&H Consulting does not guarantee the accuracy, timeliness, or reliability of any advice, opinion, statement, or other information displayed or distributed on the website.</p>
            ...
            <p>T&H Consulting will take reasonable measures to protect the website against cybersecurity threats but does not guarantee that the website is free from viruses or other harmful components.</p>

            <h3>Third-party Links</h3>
            <p>Our website may contain links to third-party websites or services that are not owned or controlled by T&H Consulting. We assume no responsibility for the content, privacy policies, or practices of these external websites and services. You acknowledge and agree that T&H Consulting shall not be liable for any damage or loss caused by or in connection with the use of any such external websites or services.</p>

            <h3><strong>Your Consent and Use of Personal Information</strong></h3>
            <p>By providing your contact details and other personal information on T&H Consulting’s website or any of its subdomains (tandhconsult.com), you hereby give your explicit consent to be contacted by our company’s employees or authorized representatives. This may involve communication via email, phone, or any other contact methods you have provided.</p>
            ...
            <p>We assure you that T&H Consulting adheres to the highest standards of data privacy and security. Your personal information is kept confidential and is only used for the purposes outlined in our Privacy Policy.</p>
            ...
            <p>We may record calls to or by T&H Consulting for quality assurance, customer service, employee training, security, legal compliance, and other lawful purposes, in accordance with relevant legislation. By communicating with us via telephone, you consent to your call being recorded.</p>

            <h3>Complaints Procedure</h3>
            <p>At T&H Consulting, we take any complaints about our services seriously. We will acknowledge receipt of your complaint within five business days and investigate it in full. We aim to resolve complaints within 30 business days, keeping you informed throughout the process. If you are unsatisfied with the outcome, you may have the right to refer the complaint to an external dispute resolution body.</p>
            ...
            <p>Any changes to these Terms and Conditions must be in writing and signed by an authorized representative of T&H Consulting. Changes will be effective upon posting to the website unless specified otherwise.</p>
            </article>
        </div>
      </section>
      <Consult/>
