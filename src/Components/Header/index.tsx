        ...
        <div className={styles.header_part}>
            <div className={styles.header_row}>
                ...
                <div className={classNames(styles.header_inner, `wow animate__animated animate__fadeInDown`)}>
                    <a className={styles.header__toggle} onClick={()=>{setModal(true)}}><span style={{background: `${color}`}}></span><span style={{background: `${color}`}}></span><span style={{background: `${color}`}}></span><span style={{background: `${color}`}}></span></a>
