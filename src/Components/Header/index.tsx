                    ...
                    <header className="App-header">
                        <ul className="wow animate__animated animate__fadeInDown">
                            ...
                            <li  className={ classNames(`${styles.nav_header} ${styles.arrow}`)}>
                                <a className={styles.page} style={{color: `${color}`}} href="">About Us</a>
                            </li>
                            <li  className={styles.nav_header}>
                                <a className={styles.page} style={{color: `${color}`}} href="">Our Team</a>
                            </li>
                            <li  className={ classNames(`${styles.nav_header} `)}>
                                <a className={styles.page} style={{color: `${color}`}} href="">Certificate</a>
                            </li>
                            <li  className={classNames(`${styles.nav_header} ${styles.arrow}`)}>
                                <a className={styles.page} style={{color: `${color}`}} href="">Solutions</a>
                            </li>
                            <li  className={ classNames(`${styles.nav_header}`)}>
                                <a className={styles.page} style={{color: `${color}`}} href="">Blog</a>
                            </li>
                            <li  className={styles.nav_header}>
                                <a className={styles.page} style={{color: `${color}`}} href="">Contact Us</a>
                            </li>
                        </ul>
                    </header>
