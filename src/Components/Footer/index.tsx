                ...
                <div className=' wow animate__animated animate__fadeInUp'>
                    ...
                    <div className={styles.footer_soc}>
                        ...
                        <a href="https://www.facebook.com/tandhconsult/" className={styles.footer_socItem}>
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="#012555" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M2 0C0.895432 0 0 0.895508 0 2V28C0 29.1045 0.895432 30 2 30H28C29.1046 30 30 29.1045 30 28V2C30 0.895508 29.1046 0 28 0H2ZM19.0007 9.65674H17.54C16.3947 9.65674 16.1733 10.2192 16.1727 11.0415V13.0005H18.7573L18.4033 15.8447H16.1733V23H13.324V15.8442H11V13H13.324V10.7593C13.324 8.32471 14.7667 7 16.8727 7C17.882 7 18.7487 7.07812 19.0007 7.11279V9.65674Z" fill="#012555"/>
                            </svg>

                        </a>
                        <a href="https://t.me/thconsult_news" className={styles.footer_socItem}>
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="#012555" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M2 0C0.895432 0 0 0.895508 0 2V28C0 29.1045 0.895432 30 2 30H28C29.1046 30 30 29.1045 30 28V2C30 0.895508 29.1046 0 28 0H2Z" fill="#012555"/>
